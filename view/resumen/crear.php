<?php
    ...
    function funcFind1($con1, $con2, $tipopla, $condic){
        ...
        $res = $mysqli->query("SELECT COLUMN_NAME AS c FROM information_schema.columns WHERE table_schema = 'of_personal' AND table_name = 'plh'");
        $columnas = [];
    ...
    $fieldAA = funcFind4('C1054', 'C1154');
        
    $fieldZ = funcFind4('C1056', 'C1154');
